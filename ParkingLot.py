...
class ParkingLot:
	...
	def createParkingLot(self,capacity):    #To get the capacity of the parking slot
		self.slots = [-1] * capacity
		self.capacity = capacity
		return self.capacity

	def getEmptySlot(self):                 #To know the amount of empty slot remaining
	...
	def getRegNoFromColor(self,color):       #To get car details with registration color
	...
	def getSlotNoFromRegNo(self,regno):     #To get slot details  with registration number
	...
	def getSlotNoFromColor(self,color):    #To get slot details with color
